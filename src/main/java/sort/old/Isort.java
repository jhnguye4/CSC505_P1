...
import java.util.*;
import java.io.*;
//import sort.old.AlgosLinkedList
...
//        System.out.println("Entered USER file: " + filename );
//        System.out.println( filename.endsWith("input.txt") );
        Scanner input = null;
    ...
    public Scanner getInputScanner(String filename) {
        System.out.println("IN getInputScanner = " + filename);
        Scanner fileScanner = null;
        try {
            File fn= new File(filename);
            try{
                System.out.println("IN fileScanner : "+ fn);
                fileScanner = new Scanner(fn);
                } catch ( Exception e){
     ...
     * it is less. It will keep oving back for each element it is less than and
...
m     * O(n^2), and is normally used for smaller data sets.
     */
    public void sort() {
